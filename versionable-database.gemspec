...
Gem::Specification.new do |s|
  s.name = %q{versionable-database}
  s.version = "0.1.1"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Josh N. Abbott"]
  s.date = %q{2009-09-23}
  s.description = %q{Ruby gem to version control Ruby on Rails model data.}
  ...
  s.summary = %q{Version control database records}
  s.test_files = [
    "test/test_helper.rb",
     "test/versionable_database_test.rb"
  ]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      s.add_development_dependency(%q<schacon-git>, [">= 0"])
    else
